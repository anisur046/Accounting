                ...
                <div className="bs-summary-banner-container no-print" style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem', borderBottom: '1px solid #e2e8f0', paddingBottom: '0.75rem' }}>
                    ...
                    <span style={{
                      ...
                      background: (Math.abs(reports.cyAssetsTotal - reports.cyLiabilitiesTotal) < 0.1 && Math.abs(reports.pyAssetsTotal - reports.pyLiabilitiesTotal) < 0.1) ? '#d1fae5' : '#fee2e2',
                      color: (Math.abs(reports.cyAssetsTotal - reports.cyLiabilitiesTotal) < 0.1 && Math.abs(reports.pyAssetsTotal - reports.pyLiabilitiesTotal) < 0.1) ? '#065f46' : '#991b1b'
                    }}>
                      {(Math.abs(reports.cyAssetsTotal - reports.cyLiabilitiesTotal) < 0.1 && Math.abs(reports.pyAssetsTotal - reports.pyLiabilitiesTotal) < 0.1) ? '✓ Balanced' : '⚠ Out of Balance'}
                    </span>
                  </div>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem' }}>
                    <div style={{ background: '#ffffff', padding: '0.75rem', borderRadius: '8px', border: '1px solid #cbd5e1', textAlign: 'center' }}>
                      ...
                      <span style={{ display: 'block', fontSize: '1rem', fontWeight: 700, color: '#0f172a' }}>
                        {Number(reports.pyAssetsTotal).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                      <span style={{
                        fontSize: '0.7rem',
                        color: Math.abs(reports.pyAssetsTotal - reports.pyLiabilitiesTotal) < 0.1 ? '#10b981' : '#ef4444',
                        fontWeight: 600
                      }}>
                        Diff: {Number(reports.pyAssetsTotal - reports.pyLiabilitiesTotal).toFixed(2)}
                      </span>
                    </div>
                    <div style={{ background: '#ffffff', padding: '0.75rem', borderRadius: '8px', border: '1px solid #cbd5e1', textAlign: 'center' }}>
                      ...
                      <span style={{ display: 'block', fontSize: '1rem', fontWeight: 700, color: '#0f172a' }}>
                        {Number(reports.pyLiabilitiesTotal).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                      <span style={{
                        fontSize: '0.7rem',
                        color: Math.abs(reports.pyAssetsTotal - reports.pyLiabilitiesTotal) < 0.1 ? '#10b981' : '#ef4444',
                        ...
                        Matches Assets: {Math.abs(reports.pyAssetsTotal - reports.pyLiabilitiesTotal) < 0.1 ? 'Yes' : 'No'}
                      </span>
                    </div>
                    <div style={{ background: '#ffffff', padding: '0.75rem', borderRadius: '8px', border: '1px solid #cbd5e1', textAlign: 'center' }}>
                      ...
                      <span style={{ display: 'block', fontSize: '1rem', fontWeight: 700, color: '#0f172a' }}>
                        {Number(reports.cyAssetsTotal).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                      <span style={{
                        fontSize: '0.7rem',
                        color: Math.abs(reports.cyAssetsTotal - reports.cyLiabilitiesTotal) < 0.1 ? '#10b981' : '#ef4444',
                        fontWeight: 600
                      }}>
                        Matches Liabilities: {Math.abs(reports.cyAssetsTotal - reports.cyLiabilitiesTotal) < 0.1 ? 'Yes' : 'No'}
                      </span>
                    </div>
                    <div style={{ background: '#ffffff', padding: '0.75rem', borderRadius: '8px', border: '1px solid #cbd5e1', textAlign: 'center' }}>
                      ...
                      <span style={{ display: 'block', fontSize: '1rem', fontWeight: 700, color: '#0f172a' }}>
                        {Number(reports.cyLiabilitiesTotal).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                      <span style={{
                        fontSize: '0.7rem',
                        color: Math.abs(reports.cyAssetsTotal - reports.cyLiabilitiesTotal) < 0.1 ? '#10b981' : '#ef4444',
                        ...
                        Diff: {Number(reports.cyAssetsTotal - reports.cyLiabilitiesTotal).toFixed(2)}
                      </span>
                    </div>
                  </div>
                </div>
